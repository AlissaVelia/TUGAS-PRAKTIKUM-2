...
public class FRAME1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DI ATM BRI SYARIAH");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/e/bank/CE.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Arial Black", 0, 29)); // NOI18N
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if(pass.getText().trim().equals("1234")) {
